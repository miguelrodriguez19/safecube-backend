...
│   │   │   └── adr-006-supabase-rls-and-database-role.md
│   │   ├── tests/
...
│       │   │               │   └── infrastructure/
│       │   │               │       └── persistence/
│       │   │               │           └── DatabaseAccessSecurityIntegrationTest.java
│       │   │               ├── user/
│       │   │               │   └── infrastructure/
│       │   │               │       └── persistence/
...
│           │           └── utils.js
│           ├── database/
│           │   └── supabase-security-test-roles.sql
